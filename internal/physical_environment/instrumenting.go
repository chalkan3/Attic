...
func (mw instrumentingMiddleware) Create(user *PhysicalEnvironment) (*PhysicalEnvironment, error) {
...
func (mw instrumentingMiddleware) Update(user *PhysicalEnvironment) (*PhysicalEnvironment, error) {
	defer func(begin time.Time) {
...
func (mw instrumentingMiddleware) Get(user *PhysicalEnvironment) (*PhysicalEnvironment, error) {
	defer func(begin time.Time) {
...
func (mw instrumentingMiddleware) List() ([]PhysicalEnvironment, error) {
	defer func(begin time.Time) {
